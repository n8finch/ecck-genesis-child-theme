...
add_action('genesis_before_loop', 'added_the_category_description');

function added_the_category_description() {
	global $post, $paged;

	$category_description = category_description( $post->ID );

	echo '<h3 class="category-news-titles">'. single_cat_title("", false) . '</h3>';
